...
const Finance = () => {
  useEffect(() => {
    document.title = "Finance - Lnassociate"; // Dynamic Title
  }, []);

  const services = [
    { title: "Term Loan", icon: "fa-search" },
    { title: "Working Capital Loan", icon: "fa-search" },
    { title: "Machinery Loan", icon: "fa-search" },
    { title: "Project Finance", icon: "fa-search" },
    { title: "Mortgage Loan", icon: "fa-search" },
    { title: "Start Up Finance", icon: "fa-search" },
  ];
